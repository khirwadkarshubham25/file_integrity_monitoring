...
urlpatterns = [
    ...
    path('file-changes', views.FileChanges.as_view(), name='file_changes'),
    path('alerts', views.Alerts.as_view(), name='alerts'),
    path('monitoring-sessions', views.MonitoringSessions.as_view(), name='monitoring_sessions'),
    path('whitelist-rules', views.WhitelistRules.as_view(), name='whitelist_rules'),
    ...
    path('api/monitoring-session-start', views.MonitoringSessionStartView.as_view(), name='api-monitoring-session-start'),
